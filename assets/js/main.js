(function() {
  ...
  const iconTablerCopy = document.querySelector('.icon-tabler-copy');
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    copyButtons.forEach(button => {
        button.addEventListener('click', () => {
            ...
            if (!highlightWrapper) {
                console.error("Could not find '.highlight-wrapper' for the copy button.");
                return;
            }
            ...
            if (!codeBlockElement) {
                console.error("Could not find 'pre code' within the highlight wrapper.");
                return;
            }
